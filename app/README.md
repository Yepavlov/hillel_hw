...
Лог — це список значень, кожне з яких з’являється після натискання однієї з двох кнопок. Унизу знаходяться старіші
події, зверху — новіші.
...
Після натискання
послідовності +, +, -, +: https://github.com/junjun-it-courses/react-hw/blob/master/task-10.1/layout2.html
